...
def start():
    displays=startfont.render(f'PRESS SPACE TO START',True,(225,225,225))
    SCREEN.blit(displays,(20,200))
    pygame.display.update()

gameoverfont1=pygame.font.Font("freesansbold.ttf",64)
gameoverfont2=pygame.font.Font("freesansbold.ttf",32)
def game_over():
    displayo=gameoverfont1.render(f'GAME OVER',True,(100,0,0))
    SCREEN.blit(displayo,(40,300))
    displayo=gameoverfont2.render(f'SCORE: {score}',True,(225,225,225))
    SCREEN.blit(displayo,(40,400))
    pygame.display.update()
...
def score_display(score):
    displays=scorefont.render(f'Score:{score}',True,(225,225,225))
    SCREEN.blit(displays,(10,10))
